...
var _countryCardOne = _interopRequireDefault(require("../templates/country-card-one.hbs"));

var _apiService = _interopRequireDefault(require("../js/api-service"));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

// import getRefs from '../js/get-refs'; 
var debounce = require('lodash.debounce'); // const refs = getRefs();


var countryContainer = document.querySelector('.js-countries-container');
var searchForm = document.querySelector('#countryName');
...
function onSearch(e) {
  ...
  if (searchQuery.length === 0) {
    ...
    _apiService.default.fetchCountry(searchQuery).then(renderCountryCard).catch(function (error) {
      return pushError('Error ;( There is no such country');
    });
  }
}
...
function renderCountryCard(country) {
  if (country.length === 1) {
    ...
    countryContainer.innerHTML = _markup;
...
},{"../css/styles.css":"src/css/styles.css","@pnotify/core":"node_modules/@pnotify/core/dist/PNotify.js","@pnotify/core/dist/PNotify.css":"node_modules/@pnotify/core/dist/PNotify.css","@pnotify/core/dist/BrightTheme.css":"node_modules/@pnotify/core/dist/BrightTheme.css","../templates/country-card.hbs":"src/templates/country-card.hbs","../templates/country-card-one.hbs":"src/templates/country-card-one.hbs","../js/api-service":"src/js/api-service.js","lodash.debounce":"node_modules/lodash.debounce/index.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
