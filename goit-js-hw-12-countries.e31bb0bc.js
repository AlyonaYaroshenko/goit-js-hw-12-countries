...
},{"_css_loader":"node_modules/parcel-bundler/src/builtins/css-loader.js"}],"src/templates/country-card.hbs":[function(require,module,exports) {
module.exports = "/country-card.75e3aba4.hbs";
},{}],"src/templates/country-card-one.hbs":[function(require,module,exports) {
module.exports = "/country-card-one.a90fa38f.hbs";
},{}],"src/js/api-service.js":[function(require,module,exports) {
"use strict";
...
function fetchCountry(name) {
  return fetch("".concat(BASE_URL, "/name/").concat(name)).then(function (response) {
...
},{}],"src/js/get-refs.js":[function(require,module,exports) {
"use strict";
...
function getRefs() {
  return {
    ...
    countryInput: document.querySelector('#countryName')
  };
}
...
var _countryCardOne = _interopRequireDefault(require("./src/templates/country-card-one.hbs"));

var _apiService = _interopRequireDefault(require("./src/js/api-service.js"));

var _getRefs = _interopRequireDefault(require("./src/js/get-refs"));
...
function onSearch(e) {
  e.preventDefault();
  var searchQuery = refs.countryInput.value; // const searchQuery = e.target.value;

  if (searchQuery.length === 0) {
    clearResult();
    return;
  } else {
    _apiService.default.fetchCountry(searchQuery).then(renderCountryCard).catch(function (error) {
      return pushError('Ooops ;( There is no such country!');
    });
  }
}
...
function renderCountryCard(country) {
  if (country.length === 1) {
    ...
    var _markup = (0, _countryCardOne.default)(country);

    console.log(_markup);
    refs.countryContainer.innerHTML = _markup;
...
},{"./src/css/styles.css":"src/css/styles.css","./src/templates/country-card.hbs":"src/templates/country-card.hbs","./src/templates/country-card-one.hbs":"src/templates/country-card-one.hbs","./src/js/api-service.js":"src/js/api-service.js","./src/js/get-refs":"src/js/get-refs.js","@pnotify/core/dist/BrightTheme.css":"node_modules/@pnotify/core/dist/BrightTheme.css","@pnotify/core/dist/PNotify.css":"node_modules/@pnotify/core/dist/PNotify.css","@pnotify/core":"node_modules/@pnotify/core/dist/PNotify.js","debounce":"node_modules/debounce/index.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
