...
},{"_css_loader":"node_modules/parcel-bundler/src/builtins/css-loader.js"}],"templates/country-card.hbs":[function(require,module,exports) {
module.exports = "/country-card.9f644dbe.hbs";
},{}],"templates/country-card-one.hbs":[function(require,module,exports) {
module.exports = "/country-card-one.a5eb9e87.hbs";
...
function fetchCountry(searchQuery) {
  return fetch("".concat(BASE_URL, "/name/").concat(searchQuery)).then(function (response) {
    return response.json(console.log(name));
  });
}
...
function onSearch() {
  var searchQuery = refs.searchForm.value;
  if (searchQuery === "") return;

  _apiService.default.fetchCountry(searchQuery).then(isFetched).catch(onFetchError);
}

function renderCountryCard(template, country) {
  var markup = template(country);
  refs.countryContainer.insertAdjacentHTML('beforeend', markup);
}

;

function isFetched(value) {
  if (value.length > 10) {
    onFetchError();
  } else if (value.length <= 10 && value.length > 1) {
    renderCountryCard(_countryCardOne.default, value);
...
function onFetchError(error) {
  (0, _core.alert)('Ooops :( Too many options. Specify the name of the country.');
}
},{"./css/styles.css":"css/styles.css","@pnotify/core":"node_modules/@pnotify/core/dist/PNotify.js","@pnotify/core/dist/PNotify.css":"node_modules/@pnotify/core/dist/PNotify.css","@pnotify/core/dist/BrightTheme.css":"node_modules/@pnotify/core/dist/BrightTheme.css","./templates/country-card.hbs":"templates/country-card.hbs","./templates/country-card-one.hbs":"templates/country-card-one.hbs","./get-refs":"get-refs.js","./api-service":"api-service.js","lodash.debounce":"node_modules/lodash.debounce/index.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
